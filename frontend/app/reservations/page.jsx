...
const ReservationPage = async () => {
    const userReservations = await apiGet("http://127.0.0.1:8000/user/auth/user-reservations/");
    return (
                ...
                userReservations.map((reservation) => (
                    <div className="p-5 grid grid-cols-1 md:grid-cols-4 gap-4 rounded-xl shadow-md border border-gray-300 mt-4 mb-4">
                        ...
                        <div className="col-span-1 text-center md:text-left md:col-span-3">
                            ...
                            <Link
                                href={`property/${reservation.property.uuid}`}
                                className="mt-6 inline-block text-base text-white py-4 px-6 rounded-xl bg-airbnb hover:bg-airbnbDark transition">
                                Go to Propery
                            </Link>
                        </div>
                    </div>
